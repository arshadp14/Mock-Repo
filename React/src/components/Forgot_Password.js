...
export class ForgotPassword extends React.Component{
    ...
    constructor(props){
        super(props);
        this.state={userEmail:"", secQuestion:"", redirectToLogin: false, session:[]};
            ...
            <div id="login-column" className="col-md-6">
                <div id="login-box" className="col-md-12">
                    <form id="login-form" className="form" onSubmit={this.handleSubmit}>
                        <h3 className="display-4 text-center text-info">Forgot Password?</h3><br></br>
                        ...
                        <div className="form-group">
                            <label className="text-info">Mother's name:</label><br></br>
                            <input type="text" name="secQuestion" value={this.state.secQuestion} onChange={this.handleChange} id="userPassword" className="form-control"></input>
                        </div>
                        <div className="form-group">
