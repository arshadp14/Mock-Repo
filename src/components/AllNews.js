...
export const AllNews = () => {
    ...
    var mostRead=news.allNews.sort((a,b) => (a.readcount < b.readcount) ? 1 : ((b.readcount < a.readcount) ? -1 : 0));
    ...
    return(
        <React.Fragment>
            ...
            <SearchByCategories news={news.allNews} categories={categories.allcategories}></SearchByCategories>
