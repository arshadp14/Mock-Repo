...
export class Login extends React.Component{
    constructor(props){
        super(props);
        this.state={userEmail:"", userPassword:"",redirectOnCancel:false, redirectToReporter: false, redirectToAdmin:false};
    ...
    render(){
        const {redirectOnCancel, redirectToReporter, redirectToAdmin } = this.state;
